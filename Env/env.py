...
class Env: 
    ...
    def __init__(self):
        ...
        self.pasta_modelo = rf"{self.pasta_base}\MODELOS BASE\3. MODELOS DE DOCUMENTOS"
    ...
    def criarPastasIniciais(self):
        ...
        self.criarPasta(self.pasta_modelo)
    ...
    def setPlanilha(self):
        try: 
            p = load_workbook(rf"{self.pasta_planilha}\ANÁLISE FISCAL.xlsx", data_only = True)
        except: 
